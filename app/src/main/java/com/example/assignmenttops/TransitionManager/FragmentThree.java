...
public class FragmentThree extends Fragment implements View.OnClickListener {
    ...
    private EditText edtf3;
    private Button btnf3;
    @Override
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        super.onViewCreated(view, savedInstanceState);
        edtf3=view.findViewById(R.id.edtf3);
        btnf3=view.findViewById(R.id.btnf3);
    ...
    public void onClick(View v) {
        ...
        String message=edtf3.getText().toString();
        ...
        //go back to fragment three
        transaction.addToBackStack(FragmentThree.class.getName());
        transaction.commit();
    }
}