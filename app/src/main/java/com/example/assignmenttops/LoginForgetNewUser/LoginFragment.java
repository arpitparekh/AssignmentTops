package com.example.assignmenttops.LoginForgetNewUser;
...
import com.example.assignmenttops.Layouts.CustomLayoutFragment;
import com.example.assignmenttops.R;
import com.example.assignmenttops.databinding.FragmentLoginBinding;
...
public class LoginFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnlogin.setOnClickListener(v -> {
            Fragment fragment=new CustomLayoutFragment();
            switchFragment(fragment);
        });
    }
