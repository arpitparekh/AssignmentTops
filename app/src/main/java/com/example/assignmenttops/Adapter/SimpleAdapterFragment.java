...
import com.example.assignmenttops.databinding.FragmentSimpleAdapterBinding;
...
public class SimpleAdapterFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull  View view, @Nullable Bundle savedInstanceState) {
        ...
        SimpleAdapter adapter=new SimpleAdapter(getContext(),data,R.layout.country,from,to);
        binding.simpleAdapter.setAdapter(adapter);
