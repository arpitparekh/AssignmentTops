...
import com.example.assignmenttops.databinding.FragmentRecyclerViewBinding;
...
public class UserRecyclerViewFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull @NotNull View view, @Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        userList.add(new User("Arpit","9601397062","arpitlksfdaf@gmail"));
        userList.add(new User("Pratik","9604497062","pratikparekh@gmail"));
        userList.add(new User("Shraddhaben","9898693670","shraddhabenparekh@gmail"));
